        ...
        return async (ctx, next) => {
            ...
            const onResponseFinished = () => {
                ...
                let resFields = {
                    ...
                    custom_status_code: ctx.body.errcode,
                };

                const level = levelFn.call(ctx, {fn: opts.levelFn, status: ctx.status, custom_status: ctx.body.errcode,err});

                ctx.log.child(resFields)[level]('response end');
